        ...
        <FormControl>
          <Stack>
            ...
            {constructionSelect.id === 5 && (
              <Stack h={260} w={'100%'} justifyContent={'center'}>
                ...
                <VStack space={2}>
                  ...
                  <VStack>
                    <StyleText>Ventana 2 (Opcional)</StyleText>
                  </VStack>
                  <HStack space={5}>
                    <Input
                      name={'lengthWindow2'}
